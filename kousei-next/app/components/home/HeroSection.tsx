  ...
  return (
    <section className="relative isolate overflow-hidden">
      ...
      <div className="max-w-[980px] mx-auto px-6 pt-28 pb-24 md:pt-40 md:pb-36 text-white">
        <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 py-1.5 text-xs font-medium tracking-wider uppercase">
          <span className="w-1.5 h-1.5 rounded-full bg-brand animate-pulse" />
          横浜市 / 神奈川県全域 / 無料回収
        </div>
        <h1 className="mt-8 text-[clamp(34px,5.5vw,64px)] font-black leading-[1.1] tracking-tight">
          横浜・神奈川のパソコン、
        ...
        <p className="mt-8 text-lg md:text-xl text-neutral-200 max-w-xl leading-relaxed">
        ...
        <div className="mt-10 flex flex-wrap gap-4">
          <a
            ...
            target="_blank"
            rel="noopener"
            className="group inline-flex items-center bg-brand text-neutral-900 font-semibold px-8 py-4 rounded-full text-base hover:bg-brand-hover transition-all shadow-2xl shadow-amber-500/30 hover:shadow-amber-500/50 hover:-translate-y-0.5 min-h-[44px]"
