          ...
          <div className="bg-amber-50 rounded-2xl border border-amber-200 p-6 mb-6">
            ...
            <ul className="space-y-2 text-sm text-amber-700">
              <li className="flex items-start gap-2">
                ...
                <span>
                  次回引き落とし日の<strong>7日前まで</strong>にご連絡ください。
                  それ以降のご連絡の場合、次回分の請求が発生する場合があります。
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-amber-500 shrink-0 mt-0.5">*</span>
              ...
              <li className="flex items-start gap-2">
                <span className="text-amber-500 shrink-0 mt-0.5">*</span>
                <span>
                  解約手続き完了後、確認メールをお送りいたします。
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-amber-500 shrink-0 mt-0.5">*</span>
                <span>
                  一時停止をご希望の場合もメールでご相談ください。
                </span>
              </li>
            </ul>
          </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-sm text-gray-700 mt-1">
                  A.
                  いいえ、解約料・違約金は一切かかりません。いつでも無料で解約できます。
                </p>
              </div>
              <div>
                <p className="font-bold text-blue-900 text-sm">
              ...
              <div>
                ...
                <p className="text-sm text-gray-700 mt-1">
                  A.
                  はい、いつでも再開できます。サイトから再度お申し込みください。
                </p>
              </div>
              <div>
                <p className="font-bold text-blue-900 text-sm">
