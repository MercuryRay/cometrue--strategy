        ...
        <div className="max-w-3xl mx-auto px-4">
          ...
          <FAQAccordion
            items={[
              ...
              [
                '定期便はいつでも解約できますか？',
                'はい、いつでも解約可能です。マイページの「支払い方法・プランを管理する」からご自身で即時解約でき、メール（info@kamuturu.jp）でも承ります。解約金や違約金は一切なく、回数縛りもありません。次回引き落とし日の前日までに解約のお手続きをいただければ、原則、次回分の請求は発生しません。',
              ],
              [
                '多頭飼いの場合、1日の量の目安は？',
          ...
          __html: JSON.stringify({
            ...
            mainEntity: [
              ...
              },
              {
                ...
                acceptedAnswer: {
                  '@type': 'Answer',
                  text: 'はい、いつでも解約可能です。マイページの「支払い方法・プランを管理する」からご自身で即時解約でき、メール（info@kamuturu.jp）でも承ります。解約金や違約金は一切なく、回数縛りもありません。次回引き落とし日の前日までに解約のお手続きをいただければ、原則、次回分の請求は発生しません。',
                },
              },
              {
                '@type': 'Question',
