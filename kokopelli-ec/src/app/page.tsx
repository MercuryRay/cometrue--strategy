          ...
          <FAQAccordion
            items={[
              ...
              [
                ...
                '水を飲まない子には、フードに直接数滴混ぜていただく方法をおすすめします。ウェットフードに混ぜると気付かれにくく、ドライフードをふやかす際にも一緒に加えていただけます。シリンジ（注射針なし）で口の横から少量ずつ与える方法も効果的です。',
              ],
              [
              ...
              [
                '効果が感じられなかった場合、本当に返金されますか？',
                'はい、ご安心ください。到着後30日以内であれば、開封後・未開封を問わず全額返金いたします。お試しいただいて合わないと感じた場合の他、効果を感じられなかった場合も対象です。マイページまたはLINE公式から手続きいただけます。',
              ],
            ]}
          />
        </div>
          ...
          __html: JSON.stringify({
            ...
            mainEntity: [
              ...
              },
              {
                ...
                acceptedAnswer: {
                  '@type': 'Answer',
                  text: '水を飲まない子には、フードに直接数滴混ぜていただく方法をおすすめします。シリンジ（注射針なし）で口の横から少量ずつ与える方法も効果的です。',
                },
              },
              {
                '@type': 'Question',
              ...
              {
                '@type': 'Question',
                name: '効果が感じられなかった場合、本当に返金されますか？',
                acceptedAnswer: {
                  '@type': 'Answer',
                  text: 'はい、ご安心ください。到着後30日以内であれば、開封後・未開封を問わず全額返金いたします。お試しいただいて合わないと感じた場合の他、効果を感じられなかった場合も対象です。',
                },
              },
            ],
          }),
